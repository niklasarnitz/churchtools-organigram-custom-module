...
export const ExclusionFilters = React.memo(() => {
    ...
    const handleIncludedGroupsChange = useCallback((values: string[]) => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col">
                <h5 className="mb-1 text-sm font-semibold text-green-700 dark:text-green-400">Nur diese Gruppen zeigen (Whitelist)</h5>
                <MultiSelect
            ...
            <div className="flex flex-col">
                <h5 className="mb-1 text-sm font-semibold text-red-700 dark:text-red-400">Gruppenrollen ausschließen</h5>
                <MultiSelect
            ...
            <div className="flex flex-col">
                <h5 className="mb-1 text-sm font-semibold text-slate-900 dark:text-slate-100 border-t pt-2 mt-2">Darstellungsoptionen</h5>
