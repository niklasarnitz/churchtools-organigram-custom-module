...
// @ts-ignore
import reactFlowStyle from 'reactflow/dist/style.css?inline';

const CONTAINER_QUERY = '.react-flow__viewport';

export const exportReactFlowToSVG = async (width: number, height: number, fileName: string, translateX: number = 0, translateY: number = 0) => {
